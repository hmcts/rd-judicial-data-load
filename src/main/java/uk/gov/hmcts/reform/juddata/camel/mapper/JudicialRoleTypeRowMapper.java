...
public class JudicialRoleTypeRowMapper implements IMapper {
    ...
    public Map<String, Object> getMap(Object roleObject) {
        ...
        roleRow.put("mrd_created_time", getDateTimeStamp(role.getMrdCreatedTime()));
        roleRow.put("mrd_updated_time", getDateTimeStamp(role.getMrdUpdatedTime()));
        roleRow.put("mrd_deleted_time", getDateTimeStamp(role.getMrdDeletedTime()));
        return  roleRow;
    }
}
